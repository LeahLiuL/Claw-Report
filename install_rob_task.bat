...
python -m pip show pywin32 >nul 2>&1 || python -m pip install pywin32
python -m pip show pycryptodome >nul 2>&1 || python -m pip install pycryptodome
python -m pip show openpyxl >nul 2>&1 || python -m pip install openpyxl
