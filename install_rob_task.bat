...
py -m pip show pywin32 >nul 2>&1 || py -m pip install pywin32
py -m pip show pycryptodome >nul 2>&1 || py -m pip install pycryptodome
py -m pip show openpyxl >nul 2>&1 || py -m pip install openpyxl
